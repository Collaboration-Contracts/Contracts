ROLES = {
  "Explain" => { title: 'Sole Decision Maker ',         action: 'Will explain my decision' },
  "Consult" => { title: 'Sole Decision Maker',         action: 'Will consult with others prior to making a decision' },
